...
trainset2 = family_features2 + heroes_features2 + didactic_features2 + alone_features2 + \
            friend_features2 + interesting_features2 + rainy_features2 + bollywood_features2


features = ['family', 'heroes', 'didactic', 'alone', 'friend', 'interesting',
            'rainy', 'bollywood']
...
class MyApp(QWidget):
    ...
    def showDialog(self):
        ...
        if ok:
            ...
            sizes = dd.values()
            # Plot
            cl = ['gold', 'yellowgreen', 'lightcoral', 'lightskyblue', 'red', 'green', 'gray', 'purple']
